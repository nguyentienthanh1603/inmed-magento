...
var LoginPopup = Class.create({
    initialize: function(options) {
        ...
        // for clinic
        this.create_clinic_click 	= $('magestore-sociallogin-create-new-clinician');
...
//        alert('redirect!');
    ...
    showCreateClinic_handler: function (){
//		this.hideFormLogin();
//		this.hideFormForgot();
//		this.mode = 'form_create';
//		this.showCreateForm();
//        alert('redirect!');
        window.location = '/customer/account/create?clinician=true';
    },
	...
	bindEventHandlers: function() {       
        ...
        // for clinicians
        if(this.create_clinic_click){
            this.create_clinic_click.observe(
                'click', this.showCreateClinic_handler.bind(this));
        }
